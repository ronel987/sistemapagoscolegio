...
<title>Editar Año Escolar</title>
        ...
        <div style="padding-top: 10px;">
           <div class="container text-white bg-dark" style="padding:20px 100px ">
            ...
            <form:form name="" method="POST" modelAttribute="ano_escolar">
             <div class="mb-3">
                <label for="exampleFormControlInput0" class="form-label">Año Escolar ID</label>
              ...
              <div class="mb-3">
                <label for="exampleFormControlInput2" class="form-label">Fecha Inicio</label>
                <form:input path="fecha_inicio" type="date" class="form-control" id="exampleFormControlInput2" />
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput3" class="form-label">Fecha Fin</label>
                <form:input path="fecha_fin" type="date" class="form-control" id="exampleFormControlInput3" />
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput4" class="form-label">Estado</label>
                <form:input path="estado" step="any" type="text" class="form-control" id="exampleFormControlInput4" />
              </div>
                                
              <div style="text-align: right;">
                <button type="submit" class="btn btn-primary btn-sm"> Guardar</button>
                <button type="button" onclick="location.href='<c:url value="/ano_escolar_listar"/>'" class="btn btn-danger btn-sm">Cancelar</button>
              </div>
