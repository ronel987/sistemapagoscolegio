...
<div class="container">
    <div class="row" style="padding: 20px;">
      ...
      <div class="col-md-10" style="background: #fff;padding: 20px;min-height: calc(100vh);">
        <h6>Editar un Apoderado</h6>
        <div style="padding-top: 10px;">
           <div class="container text-white bg-dark" style="padding:20px 100px ">
            <!--formulario:-->
            <form:form name="" method="POST" modelAttribute="apoderado">
             <div class="mb-3">
                <label for="exampleFormControlInput0" class="form-label">DNI Apoderado</label>
                <form:input path="dni" readOnly="true" type="text" class="form-control" id="exampleFormControlInput0" />
              </div>              
              <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="exampleFormControlInput3" class="form-label">Sexo</label>
                <form:input path="sexo" type="text" class="form-control" id="exampleFormControlInput3" />
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput4" class="form-label">Correo</label>
                <form:input path="correo" type="text" class="form-control" id="exampleFormControlInput4" />
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput5" class="form-label">Celular</label>
                <form:input path="celular" type="text" class="form-control" id="exampleFormControlInput5" />
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput6" class="form-label">Direccion</label>
                <form:input path="direccion" type="text" class="form-control" id="exampleFormControlInput6" />               
              </div>
