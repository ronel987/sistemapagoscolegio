           ...
           <div class="container text-white bg-dark" style="padding:20px 100px ">
            ...
            <form:form name="" method="POST" modelAttribute="matricula">
              <div class="mb-3">
                ...
                <form:input type="text" path="fecha_matricula" class="form-control" id="exampleFormControlInputID" readonly="true" />
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Estado</label>
                <form:input type="text" path="estado" class="form-control" id="exampleFormControlInput1" readonly="true" />
              </div>

              <p>Eliminar Matricula</p>

              <div style="text-align: right;">
                <button type="submit" class="btn btn-primary btn-sm"> Si</button>
                <button type="button" onclick="location.href='/mil/matricula_listar'" class="btn btn-danger btn-sm">Cancelar</button>
              </div>
            </form:form> 
           </div>
        </div>
