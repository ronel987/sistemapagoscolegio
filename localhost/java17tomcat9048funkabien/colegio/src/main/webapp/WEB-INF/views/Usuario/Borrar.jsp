    ...
    <div class="row" style="padding: 20px;">
      <div class="col-md-2" style="padding-right:20px;">
        ...
        <div class="list-group">  
          ...
          <a href="/mil/usuario_listar" class="list-group-item list-group-item-action">Listar Autos</a>        
        </div>
      </div>
        ...
        <div style="padding-top: 10px;">
           <div class="container text-white bg-dark" style="padding:20px 100px ">
            ...
            <form:form name="" method="POST" modelAttribute="usuario">
              <div class="mb-3">
                <label for="exampleFormControlInputID" class="form-label">Usuario ID</label>
              ...
              <p>No podrás borrar Usuarios cuyos ID existen en la tabla Pago</p><br>

              <div style="text-align: right;">
                <button type="submit" class="btn btn-primary btn-sm"> Yes, delete</button>
                <button type="button" onclick="location.href='/mil/usuario_listar'" class="btn btn-danger btn-sm">Cancelar</button>
              </div>
            </form:form> 
           </div>
        </div>
