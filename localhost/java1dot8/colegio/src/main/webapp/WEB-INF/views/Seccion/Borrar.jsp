        ...
        <div style="padding-top: 10px;">
           <div class="container text-white bg-dark" style="padding:20px 100px ">
            ...
            <form:form name="" method="POST" modelAttribute="seccion">
              <div class="mb-3">
                <label for="exampleFormControlInputID" class="form-label">Seccion ID</label>
              ...
              <div class="mb-3">
                ...
                <form:input type="text" path="estado" class="form-control" id="exampleFormControlInput2" readonly="true"/>
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput3" class="form-label">Grado ID</label>
                <form:input type="text" path="grado.id" class="form-control" id="exampleFormControlInput3" readonly="true" />	                 
              </div>
              <p>¿Seguro que quiere borrar?</p><br>

              <div style="text-align: right;">
                <button type="submit" class="btn btn-primary btn-sm"> Borrar</button>
                <button type="button" onclick="location.href='/mil/seccion_listar'" class="btn btn-danger btn-sm">Cancelar</button>
              </div>
            </form:form> 
           </div>
        </div>
