    ...
    <div class="row" style="padding: 20px;">
      <div class="col-md-2" style="padding-right:20px;">
        ...
        <div class="list-group">  
          ...
          <a href="/mil/alumno_listar" class="list-group-item list-group-item-action">Listar Alumno</a>        
        </div>
      </div>
        ...
        <div style="padding-top: 10px;">
           <div class="container text-white bg-dark" style="padding:20px 100px ">
            ...
            <form:form name="" method="POST" modelAttribute="alumno">
              <div class="mb-3">
                <label for="exampleFormControlInputID" class="form-label">Nombres </label>
                <form:input type="text" path="nombres" class="form-control" id="exampleFormControlInputID" readonly="true" />
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Apellidos</label>
                <form:input type="text" path="apellidos" class="form-control" id="exampleFormControlInput1" readonly="true" />
              </div>
              ...
              <div style="text-align: right;">
                ...
                <button type="button" onclick="location.href='/mil/alumno_listar'" class="btn btn-danger btn-sm">Cancelar</button>
              </div>
            </form:form> 
           </div>
        </div>
