    ...
    <div class="row" style="padding: 20px;">
      <div class="col-md-2" style="padding-right:20px;">
        ...
        <div class="list-group">  
          ...
          <a href="/mil/grado_listar" class="list-group-item list-group-item-action">Listar Grados</a>        
        </div>
      </div>
      <div class="col-md-10" style="background: #fff;padding: 20px;min-height: calc(100vh);">
        ...
        <div style="padding-top: 10px;">
           <div class="container text-white bg-dark" style="padding:20px 100px ">
            ...
            <!--formulario:-->
            <form:form name="" method="POST" modelAttribute="grado">
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <form:input type="text" readonly="true" path="nombre" class="form-control" id="exampleFormControlInput1"  />
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput2" class="form-label">Estado</label>
                <form:input type="text" readonly="true" path="estado" class="form-control" id="exampleFormControlInput2" />
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput3" class="form-label">Año Escolar ID</label>
                <form:input type="text" path="ano_escolar.id" class="form-control" id="exampleFormControlInput3" readonly="true" />	                 
              </div>
              
              <p>¿Seguro que quiere borrar?</p>
              <p>No podrás borrar Grados cuyos ID existen en la tabla Seccion</p><br>

              <div style="text-align: right;">
                <button type="submit" class="btn btn-primary btn-sm"> Borrar</button>
                <button type="button" onclick="location.href='/mil/grado_listar'" class="btn btn-danger btn-sm">Cancelar</button>
              </div>
            </form:form> 
           </div>
        </div>
