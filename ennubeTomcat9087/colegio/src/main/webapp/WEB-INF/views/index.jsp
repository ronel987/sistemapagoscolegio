    ...
    <div class="row" style="padding: 20px;">
      ...
      <div class="col-md-10" style="background: #fff;padding: 20px; min-height: calc(100vh-15px);">
        ...
        <div class="row">
          <div class="col-md-3">
            <figure class="figure">
              <img src="<c:url value='/images/autos.jfif' />" class="figure-img img-fluid rounded">
          ...
          <div class="col-md-3">
            <figure class="figure">
              <img src="<c:url value='/images/marcas.jfif' />"  class="figure-img img-fluid rounded">
              <div style="padding-bottom: 5px;">
                <figcaption class="figure-caption" style="text-align: justify;">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsam voluptatibus atque veniam sapiente provident. Quasi nisi a, recusandae totam, minima mquam quos aspernatur et asperiores ducimus omnis est.
                </figcaption>
          ...
          <div class="col-md-3">
            <figure class="figure">
              <img src="<c:url value='/images/carreras.jfif' />"  class="figure-img img-fluid rounded">
              <div style="padding-bottom: 5px;">
                <figcaption class="figure-caption" style="text-align: justify;">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsam voluptatibus atque veniam sapiente provident. Quasi nisi a, recusandae totam, minima mquam quos aspernatur et asperiores ducimus omnis est.
                </figcaption>
